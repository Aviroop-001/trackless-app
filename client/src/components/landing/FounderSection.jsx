      ...
      <div className="mx-auto max-w-2xl px-6 text-center">
        ...
        <ScrollSection delay={120}>
          <div className="mt-12 inline-flex flex-col items-center gap-4">
            <div className="h-20 w-20 rounded-full bg-linear-to-br from-violet-500 to-cyan-400 grid place-items-center text-2xl font-bold text-white shadow-lg shadow-cyan-500/20 ring-2 ring-white/10">
              A
            </div>
            <div>
